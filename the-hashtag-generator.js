...
//   Wasn't working at first. Here is what I changed to fix it. I think it was reading an empty string as a string and concatenating it to the #.
...
// In order to prevent this, add string = str.trim() at the start of the function to ensure that those edge cases don't slip through the cracks.
